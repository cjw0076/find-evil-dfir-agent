...
Records every tool call, hypothesis, contradiction, and self-correction with a
monotonic step index and timestamp. Writing it out gives the judges a
"replay the agent's reasoning" artifact (Audit Trail Quality criterion).
"""
